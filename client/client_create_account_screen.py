...
class CreateAccountScreen(tk.Frame):
    ...
    def grid_placement(self):
        self.label_server.grid(row=0, column=0, columnspan=2, sticky=tk.EW)
        self.label_username.grid(row=1, column=0, padx=10, sticky=tk.E)
        self.label_password.grid(row=2, column=0, padx=10, sticky=tk.E)
        self.label_gpg_key.grid(row=3, column=0, padx=10, sticky=tk.E)
        self.entry_username.grid(row=1, column=1)
        self.entry_password.grid(row=2, column=1)
        self.entry_gpg_key.grid(row=3, column=1)
        self.label_password_error.grid(row=1, column=2, rowspan=4, padx=10, sticky=tk.W)
        self.button_back.grid(row=4, column=0, padx=10, pady=10)
        self.button_create_account.grid(row=4, column=1, padx=10, pady=10)
